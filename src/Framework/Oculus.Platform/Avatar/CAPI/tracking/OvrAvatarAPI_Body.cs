...
namespace Oculus.Avatar2
{
    public static partial class CAPI
    {
        ...
        public const int MaxHandBones = (int)ovrAvatar2HandTrackingBoneId.Count;
        ...
        [StructLayout(LayoutKind.Sequential)]
        public struct ovrAvatar2HandTrackingDataContextNative
        {
            public IntPtr context;
        ...
        public delegate bool InputControlCallback(out ovrAvatar2InputControlState inputControlState, IntPtr userContext);
        [StructLayout(LayoutKind.Sequential)]
        public struct ovrAvatar2InputControlContext
        {
            public IntPtr context;
        ...
        [StructLayout(LayoutKind.Sequential)]
        public struct ovrAvatar2InputControlContextNative
        {
            public IntPtr context;
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.U1)]
        public delegate bool InputTrackingCallback(out ovrAvatar2InputTrackingState inputTrackingState, IntPtr userContext);
        [StructLayout(LayoutKind.Sequential)]
        public struct ovrAvatar2InputTrackingContext
        {
            public IntPtr context;
        ...
        [StructLayout(LayoutKind.Sequential)]
        public struct ovrAvatar2InputTrackingContextNative
        {
            public IntPtr context;
        ...
        public static extern ovrAvatar2Result ovrAvatar2Body_CreateProvider(ovrAvatar2BodyProviderCreateFlags flags, out IntPtr bodyTrackingContext);
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern ovrAvatar2Result ovrAvatar2Body_DestroyProvider(IntPtr bodyTrackingContext);
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern ovrAvatar2Result ovrAvatar2Body_SetOffset(IntPtr bodyTrackingContext, ovrAvatar2BodyMarkerTypes type, in ovrAvatar2Transform inputTransforms);
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern ovrAvatar2Result ovrAvatar2Body_RestartTracking(IntPtr bodyTrackingContext);
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern ovrAvatar2Result ovrAvatar2Body_SetHandTrackingContext(IntPtr bodyTrackingContext, in ovrAvatar2HandTrackingDataContext handContext);
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl, EntryPoint = "ovrAvatar2Body_SetHandTrackingContext")]
        public static extern ovrAvatar2Result ovrAvatar2Body_SetHandTrackingContextNative(IntPtr bodyTrackingContext, in ovrAvatar2HandTrackingDataContextNative handContext);
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern ovrAvatar2Result ovrAvatar2Body_SetInputControlContext(IntPtr bodyTrackingContext, in ovrAvatar2InputControlContext context);
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl, EntryPoint = "ovrAvatar2Body_SetInputControlContext")]
        public static extern ovrAvatar2Result ovrAvatar2Body_SetInputControlContextNative(IntPtr bodyTrackingContext, in ovrAvatar2InputControlContextNative context);
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern ovrAvatar2Result ovrAvatar2Body_SetInputTrackingContext(IntPtr bodyTrackingContext, in ovrAvatar2InputTrackingContext context);
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl, EntryPoint = "ovrAvatar2Body_SetInputTrackingContext")]
        public static extern ovrAvatar2Result ovrAvatar2Body_SetInputTrackingContextNative(IntPtr bodyTrackingContext, in ovrAvatar2InputTrackingContextNative context);
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern ovrAvatar2Result ovrAvatar2Body_InitializeDataContext(IntPtr bodyTrackingContext, out ovrAvatar2TrackingDataContext dataContext);
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl, EntryPoint = "ovrAvatar2Body_InitializeDataContext")]
        public static extern ovrAvatar2Result ovrAvatar2Body_InitializeDataContextNative(IntPtr bodyTrackingContext, out ovrAvatar2TrackingDataContextNative dataContext);
    }
}
