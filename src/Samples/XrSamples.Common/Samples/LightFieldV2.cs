...
namespace XrSamples
{
    ...
    {
        [Sample("Light Field V2")]
        public static XrEngineAppBuilder CreateLightFieldV2(this XrEngineAppBuilder builder)
        {
            ...
            return builder
                ...
                .ConfigureApp(cfg =>
                {
                    ...
                    var lightField = scene.AddComponent(new LightFieldDebugV2(grid)
                    {
