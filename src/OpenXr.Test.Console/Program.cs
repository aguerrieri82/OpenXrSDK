...
var res2 = OculusXrPlugin.LoadOVRPlugin(null);

var isSup = OculusXrPlugin.GetIsSupportedDevice();
...
OculusXrPlugin.SetUserDefinedSettings(settings);

var headSet = OculusXrPlugin.GetSystemHeadsetType();
